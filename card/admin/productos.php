...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm" id="abrirProducto"><i class="fas fa-plus fa-sm text-white-50"></i> Nuevo</a>
</div>
<div class="row">
    <div class="col-md-12">
                    ...
                    while ($data = mysqli_fetch_assoc($query)) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="post" action="actualizar_producto.php?act=pro&id=<?php echo $data['id']; ?>" class="d-inline actualizar">
