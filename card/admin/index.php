                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block ">
                                <img class="img-thumbnail" src="img/logo.jpeg" alt="">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="" autocomplete="off">
                                        ...
                                        <hr>
                                        <a type="button" href="../index.php" class="btn btn-success btn-user" text-styule><b style="color:black";>Regresar a la Tienda</b></a>
                                    </form>
                                </div>
                            </div>
                        </div>
